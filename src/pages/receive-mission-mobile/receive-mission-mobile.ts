...
/**
 * Generated class for the ReceiveMissionMobilePage page.
 *
...
@IonicPage()
@Component({
  selector: "page-receive-mission-mobile",
  templateUrl: "receive-mission-mobile.html",
})
export class ReceiveMissionMobilePage {
  user = "";
  character = "";
  depart = "";
  ...
  ionViewDidLoad() {
    console.log("ionViewDidLoad ReceiveMissionMobilePage");
